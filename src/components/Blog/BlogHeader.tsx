            ...
            <div className="max-w-8xl mx-auto px-4">
                <div className="flex justify-between items-center py-2">
                    ...
                    <div className="hidden lg:flex items-center space-x-1">
                        ...
                        >
                            <button className={`flex items-center space-x-1 px-2 py-1.5 relative transition-colors duration-200 text-black hover:text-secondary after:absolute after:bottom-0 after:left-0 after:h-[2px] after:bg-current after:w-0 after:transition-all after:duration-300 hover:after:w-full`}>
                    ...
                    <div className="hidden lg:flex">
                        <button
                            onClick={() => window.open('https://calendly.com/2btechinc/discoverywith2btech', '_blank')}
                    ...
                    <div className="lg:hidden">
                        <button onClick={toggleMenu} className="p-2 rounded-lg transition-colors duration-200">
                            <div className="w-6 h-6 flex flex-col justify-center items-center relative">
                                <span className={`block absolute h-0.5 w-6 transition-all duration-300 bg-black ${isOpen ? "rotate-45 top-2.5" : "top-1"}`}/>
                                <span className={`block absolute h-0.5 w-6 transition-all duration-300 bg-black ${isOpen ? "opacity-0" : "top-2.5"}`}/>
                                <span className={`block absolute h-0.5 w-6 transition-all duration-300 bg-black ${isOpen ? "-rotate-45 top-2.5" : "top-4"}`}/>
                            </div>
                        </button>
                    </div>
                </div>
                    ...
                    <div className="py-4 space-y-2 border-t border-black">
                                ...
                                <div className="mt-2 space-y-1 animate-slideDown">
                                    {servicesItems.map((item, index) => (
                                        <div key={index} className="border-b border-gray-100 last:border-b-0">
                                            {/* FIX: was a non-navigating <button>, now a proper <Link> */}
                                            <Link
                                                href={item.path}
                        ...
                        <div className="pt-4 px-2">
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-primary to-secondary text-white py-3 rounded-lg font-semibold transition-all duration-200 shadow-lg"
                            >
                                Get proposal
                            </button>
                        </div>
