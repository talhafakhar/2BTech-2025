        ...
        <div className="min-h-screen font-syne">
            ...
            >
                <div className="max-w-5xl mx-auto px-6 lg:px-8">
                        ...
                        <motion.div className="flex flex-wrap items-center gap-6 text-gray-600 mb-8" variants={fadeInUp}>
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium">
                                    Published {formatDate(blog.attributes.publishedAt)}
                                </span>
                            </div>
                            {blog.attributes.updatedAt &&
                                blog.attributes.updatedAt !== blog.attributes.publishedAt && (
                                    <div className="flex items-center gap-2">
                                        <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                                        <span className="text-sm font-medium">
                                            Updated {formatDate(blog.attributes.updatedAt)}
                                        </span>
                                    </div>
                                )}
                        </motion.div>
                    ...
                    <motion.article className="max-w-none mb-16" variants={fadeInUp} initial="hidden" animate="visible">
                        <motion.div
