                                    ...
                                    {servicesItems.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <ChevronDown
                                                    className={`h-4 w-4 transition-transform duration-200 ${
                                                        activeSubmenu === `service-${index}` ? "rotate-180" : ""
                                                    }`}
                                                />
                                            </button>

                                            {activeSubmenu === `service-${index}` && (
                                                <div className="pb-2 pl-8 space-y-2 animate-slideDown">
                                                    {item.options.map((opt, i) => (
                                                        <Link
                                                            href={opt.path}
                                                            key={i}
                                                            className="flex items-center space-x-2 text-sm py-2 px-3 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors duration-200"
                                                            onClick={() => {
