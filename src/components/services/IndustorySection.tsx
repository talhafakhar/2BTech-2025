...
const sectors: Sector[] = [
    ...
    { id: "realEstate", title: "Real Estate", imageUrl: "/assets/Home/slide-13.svg" },
    { id: "e-commerce", title: "E-commerce", imageUrl: "/assets/Home/slide-1.svg" },
    { id: "manufacturing", title: "Manufacturing ", imageUrl: "/assets/Home/slide-2.svg" },
    { id: "professionalServices", title: " Professional Services", imageUrl: "/assets/Home/slide-3.svg" },
    { id: "education", title: "Education ", imageUrl: "/assets/Home/slide-4.svg" },
    { id: "logistics", title: "Logistics", imageUrl: "/assets/Home/slide-5.svg" },
];
const duplicatedLogos = [...sectors, ...sectors, ...sectors];

const ServicesIndustrySection: React.FC = () => {
    return (
        <section className="relative overflow-hidden py-10 pl-2 ">
...
export default ServicesIndustrySection;
