...
const InfiniteLogoSlider:React.FC= () => {
    ...
    return (
        <section className="relative w-full overflow-hidden bg-white/60">
            <div className="container mx-auto  w-full flex flex-col md:flex-row px-4 items-center  gap-6 md:gap-0">
                    <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold border-black border-b-2 md:border-b-0 md:border-r-4   w-full  pb-4 md:pb-0">
