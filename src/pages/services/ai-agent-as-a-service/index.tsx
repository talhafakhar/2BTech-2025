...
export default function aiAgentAsAService() {
        ...
        Rasa: () => (
            ...
            >
                ...
                <g fill="#5A17EE" mask="url(#mask0_14016_828)">
                    <path
                        d="M69.68 9.668v16.703h3.972v-5.036h8.607v5h3.972V9.668zm12.58 7.667h-8.608v-3.667h8.607zM66.041 18.835v7.5h-16.22v-4h12.248V20H49.82V9.668h16.221v4H53.793V16H66.04zM29.625 9.668v16.703h3.972v-5.036h8.607v5h3.973V9.668zm12.58 7.667h-8.608v-3.667h8.607zM20.66 19.981l5.085-1.863.241-.097V9.668H9.766v16.667h3.92V22.53l2.978-1.086 4.486 4.89h4.906zm-6.952-1.706v-4.607h8.306v1.56z"></path>
                    <path
                        d="M81.815 30.181h7.915V6.148H6.27v24.033h59.586l15.952 7.94v-7.94zM1.82 1.668H94.18v33h-7.915v10.667L64.823 34.668H1.82z"></path>
                    <path
                        d="m93.18 38.169-.645-1.575h.325l.419 1.078.42-1.078h.325l-.648 1.575zm-.745 0v-1.575h.355v1.575zm1.334 0v-1.575h.353v1.575zm-2.434 0V36.73h.353v1.438zm-.476-1.278v-.297h1.305v.297z"></path>
                </g>
            </svg>
        ),
        Dialogflow: () => (
    ...
    return (
        <div className="font-syne">
            <NextSeo
                title="Build AI Agents | AI Agent Development & Automation - 2BTech"
                description="Build AI agents with 2BTech’s expert development services. Deploy autonomous AI, chatbots, and workflow automation solutions for your business."
