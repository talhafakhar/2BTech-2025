...
import IndustryServiceSection from "@/components/services/industryServiceSection";

export default function AiAndGenerativeAiSolutions() {
    const faqs = [
        {
            id: 1,
            question: "What is artificial intelligence (AI)?",
            answer:
                "AI is a branch of computer science that aims to create machines capable of intelligent behavior. It includes technologies like machine learning, natural language processing, computer vision, and robotics. AI systems learn from data, recognize patterns, make decisions, and perform tasks requiring human intelligence.",
        },
        {
            id: 2,
            question: "How can AI benefit my business?",
            answer:
                "AI automates complex tasks, provides deep data insights, enhances customer experiences, improves decision-making, and drives innovation. Benefits include efficiency, cost reduction, risk management, personalization, and competitive advantage through intelligent automation and predictive analytics.",
        },
        {
            id: 3,
            question: "What are generative AI solutions?",
            answer:
                "Generative AI solutions use advanced machine learning models to create new content such as text, images, and code. They leverage large language models (LLMs) to automate content creation, enhance productivity, and enable capabilities like conversational AI and creative assistance.",
        },
        {
            id: 4,
            question: "What is the difference between AI consulting and AI implementation services?",
            answer:
                "AI consulting focuses on strategy, planning, and identifying opportunities, while AI implementation involves the actual development, integration, and deployment of AI solutions. Successful projects often combine both for end-to-end execution.",
        },
        {
            id: 5,
            question: "How long does it take to implement custom AI solutions?",
            answer:
                "Timelines vary by project complexity and data readiness. Simple proofs of concept take 4–8 weeks, while full-scale AI solutions require 3–9 months. We use an agile approach for faster value delivery.",
        },
        {
            id: 6,
            question: "What types of data do I need for AI implementation?",
            answer:
                "Data requirements depend on your AI use case. Typically, you need relevant, clean, and sufficient historical data. Our team performs a data readiness assessment and assists with data collection, cleaning, and preparation.",
        },
        {
            id: 7,
            question: "How do you ensure AI model accuracy and reliability?",
            answer:
                "We conduct rigorous testing, validation, and quality assurance, including cross-validation, benchmarking, and bias detection. Continuous monitoring and feedback loops ensure ongoing model improvement and reliable performance post-deployment.",
        },
    ];
    const servicesData = [
        {
            ...
            description:
                "Our experts work with you to establish clear goals for AI implementation and pinpoint the strategic opportunities where AI can deliver maximum value. Our AI consulting services help businesses navigate the complexities of AI adoption with confidence.",
            keyFeatures: [
                "AI readiness assessment and maturity evaluation",
                "Custom AI roadmap development aligned with business goals",
        ...
        },
        {
            ...
            description:
                "Implement state-of-the-art generative AI solutions that create content, automate workflows, and unlock new possibilities for innovation. Our generative AI consulting services help you leverage technologies like GPT, Claude, and custom large language models.",
            keyFeatures: [
                "Custom GPT and LLM development and fine-tuning",
                ...
                "Image and video generation solutions",
            ],
        },
        {
            id: 3,
        ...
        },
        {
            ...
            description:
                "We develop systems that can understand, interpret, and generate human language, enabling applications like sentiment analysis, document processing, and conversational AI.",
            keyFeatures: [
        ...
        {
            id: 6,
            title: "AI-Powered Chatbots & Conversational AI",
            description:
        ...
        },
        {
            ...
            description:
                "Utilizing AI to forecast future trends based on existing data, aiding in decision-making processes across various business functions and industries.",
            keyFeatures: [
    ...
    const StackIcons = {
        ...
        LlamaIndex: () => (
            ...
            >
                <defs>
                    ...
                    >
                        <stop offset="0" stopColor="#f6ddd7"></stop>
                        <stop offset="0.25" stopColor="#fcabe6"></stop>
                        <stop offset="0.3" stopColor="#f3ade6"></stop>
                        <stop offset="0.38" stopColor="#ddb3e8"></stop>
                        <stop offset="0.48" stopColor="#b8bcec"></stop>
                        <stop offset="0.59" stopColor="#85caf1"></stop>
                        <stop offset="0.7" stopColor="#50d8f6"></stop>
                        <stop offset="0.76" stopColor="#50d8f6"></stop>
                        <stop offset="0.86" stopColor="#b58fe8"></stop>
                    </linearGradient>
                </defs>
                <rect
                    id="SquareBG"
                ...
                <path
                    ...
                    strokeWidth="0"
                    d="M1227.57 1375.94c-3.92-4.37-7.85-8.74-11.77-13.1-27.64-30.21-41.35-65.1-30.46-111.35-104.67 33.94-205.19 41.62-308.99 17.88-2.72 31.05-3.81 59.43-8.02 87.34-5.15 34.16-13.02 67.9-19.47 101.86-2.25 11.83-4.72 23.74-5.46 35.71-2.2 35.64-1.41 71.63-6.21 106.88-2.47 18.13-14.33 34.99-21.3 50.93h-77.71l.42-.97c4.15-11.29 8.29-22.58 12.44-33.87l-.21.27c4.2-4.21 8.39-8.43 12.59-12.64l-.27.27c2.12-2.13 4.24-4.25 6.36-6.38l11.44-1.32c1.11-18.89.94-11.95 1.11-18.89.83-33.72.34-67.53-1.47-101.21-.67-12.36-6.26-24.46-9.6-36.68l-6.96.18-37.17 134.11.55-.24c-8.87 16.08-21.35 47.27-30.22 63.35-11.03 1-42.13-.92-67.88-.77 2.1-21.24 9.98-32.37 23.37-44.39 28.79-25.84 36.54-63.75 36.43-100.05-.15-50.7-6.92-101.37-10.86-152.06 5.59-10.19 8.83-23.19 17.14-30.11 56.24-46.85 102.12-102.83 144.95-161.48 41.46-56.78 83.19-113.45 122.26-171.88 43.03-64.36 87.61-128.6 97.48-208.71 72.88 7.68 142.46 25.43 207.78 60.42 19.96 10.69 45.01 11.89 67.72 17.44 8.42 6.5 20.9 11.26 24.57 19.8 18.5 43.03 36.6 86.42 51.23 130.87 17.99 54.67 22.8 110.74 13.5 168.57-11.14 69.24-41.63 128.83-80.9 185.36-6.53 9.41-8.65 21.88-12.81 32.94l.15-.18c-6.82 4.82-14.03 9.18-20.38 14.54-17.18 14.49-21.33 42.61-48.67 46.55-.37-1.49-.55-2.99-.52-4.53-1.44-2.72-2.87-5.43-4.31-8.15-9.96-18.77-19.93-37.53-29.89-56.3ZM517.28 570.6c-10.46-.44-21.29 7.69-31.95 11.86 0 0-9.76 80.82-9.76 121.49s13.91 75.15 16.27 113.41c1.68 27.25 3.01 56.38 13.57 80.73 12.68 29.21 18.19 57.44 16.61 88.5-4.38 86.3 40.37 144.69 108.96 189.16 30.85-33.52 64.34-65 91.99-100.98 55.34-72.02 102.6-149.18 128.62-237.37 5.42-18.37 8.99-37.27 14.28-59.58 2.88-2.94 8.79-8.99 14.7-15.04l-141.94-.4c-2.09-1.89-3.55-3.22-5.64-5.11l-17.96-175.16c-65.91-4.05-131.8-8.74-197.77-11.52Zm148.56-208.77c-23.76-47.96-58.65-85.02-111.51-106.14-.84 14.47-1.52 26.06-2.26 38.88-17.66-12.73-33.28-23.98-53.45-38.52 2.58 25.98 5.08 44.11 6.04 62.33 1.89 36.02-13.58 54.11-49.86 59.15-7.07.98-14.41 0-21.52.83-21.28 2.46-32.65 14.43-35.51 35.63-3.74 27.68 10.41 45.81 33.06 56.83 23.57 11.47 48.7 19.75 77.45 31.13-4.21 14.19-8.49 28.22-12.51 42.32-3.62 12.69-6.95 25.46-10.41 38.2 10.66-4.17 21.48-12.3 31.95-11.86 65.97 2.78 131.86 7.46 197.77 11.52-3.72-76.27-14.91-151.03-49.22-220.28Zm698.12 1062.75 5.87 6.14c2.05 2.06 4.1 4.12 6.15 6.17 2.04 1.96 4.07 3.92 6.11 5.88 7.5 4.99 15 9.99 22.49 14.98 3.64-19.55 25.85-47.67 44.43-61.31 7.67-5.63 11.05-16.91 16.99-25.18 3.32-4.62 7.89-8.34 11.9-12.46-1.62-13.04-4.17-26.03-4.67-39.11-1.43-37.53.92-74.57-10.84-112.04-14.13-45-8.64-92.52-6.02-140.17 43.12-8.67 61.47-36.79 63.89-74.64 2.92-45.72-5.65-89.82-34.29-127.23-20.53-26.81-48.34-41.86-82.84-36.43-22.85 3.59-45.04 11.37-67.53 17.28 8.42 6.5 20.9 11.26 24.57 19.8 18.5 43.03 36.6 86.42 51.23 130.87 17.99 54.67 22.8 110.74 13.5 168.57-11.14 69.24-41.63 128.83-80.9 185.36-6.53 9.41-8.65 21.88-12.81 32.94l32.78 40.58Zm-378.22-659.2c-6.29 81.15-44.94 149.41-87.84 215.37-37.77 58.07-75.75 116.3-118.15 170.97-30.45 39.26-68.33 72.77-102.9 108.84l1.41 80.23c5.59-10.19 8.83-23.19 17.14-30.11 56.24-46.85 102.12-102.83 144.95-161.48 41.46-56.78 83.19-113.45 122.26-171.88 43.03-64.36 87.61-128.6 97.48-208.71-24.78-1.08-49.56-2.15-74.34-3.23Zm-321.2 433.39c31.99-35.25 67.97-67.72 95.05-106.41 41.85-59.77 79.26-122.86 115.33-186.36 20.46-36.01 35.34-75.24 37.26-118.13.34-7.72 8.23-15.09 12.63-22.63l-10.85.3c-4.64-.95-9.28-1.91-13.91-2.86-6.49.04-12.97.07-19.46.11-5.91 6.05-11.83 12.1-14.7 15.04-5.29 22.3-8.87 41.21-14.28 59.58-26.02 88.19-73.28 165.35-128.62 237.37-27.65 35.98-61.14 67.46-91.99 100.98 11.18 7.67 22.36 15.34 33.54 23.02Zm278.18-433.54c2.4 67.42-27.68 124.69-59.91 180.03-31.13 53.43-66.12 104.74-101.63 155.44-20.89 29.83-45.84 56.84-69.42 84.74-11.1 13.13-23.27 25.36-34.96 37.99.02 12.38.03 24.75.05 37.13 34.57-36.07 72.45-69.58 102.9-108.84 42.4-54.66 80.39-112.89 118.15-170.97 42.9-65.96 81.55-134.22 87.84-215.37l-43.03-.15Zm463.01 697.41c5.46 11.19 15.47 22.34 15.54 33.56.25 39.8-2.64 79.65-5.17 119.42-.22 3.52-6.45 6.66-9.89 9.98-2.3 1.72-4.61 3.44-6.91 5.16-1.99 2.12-3.98 4.24-5.97 6.35-2.17 1.91-4.35 3.81-6.52 5.72 3.41 3.84 6.65 10.81 10.25 11 20.21 1.08 40.5.52 61.67.52 17.8-43.47 23.9-85.93 17.32-130.35-1.3-8.8-3.75-19.81.05-26.59 25.92-46.24 19.03-92.21 1.8-138.62-4.01 4.12-8.58 7.84-11.9 12.46-5.94 8.27-9.32 19.55-16.99 25.18-18.58 13.64-40.79 41.76-44.43 61.31.29 1.65.67 3.28 1.15 4.89ZM924.82 765.23c-4.4 7.53-12.29 14.91-12.63 22.63-1.92 42.89-16.8 82.12-37.26 118.13-36.08 63.51-73.48 126.6-115.33 186.36-27.09 38.69-63.06 71.15-95.05 106.41 4.09 8.22 8.17 16.44 12.26 24.66 11.69-12.64 23.86-24.86 34.96-37.99 23.58-27.89 48.53-54.91 69.42-84.74 35.5-50.7 70.5-102.01 101.63-155.44 32.23-55.34 62.31-112.61 59.91-180.03h-17.9Zm-24.77-2.56c4.64.95 9.28 1.91 13.91 2.86-4.64-.95-9.28-1.91-13.91-2.86m-166.78-2.84c1.79.85 3.59 1.7 5.38 2.55-1.6-1.25-3.4-2.1-5.38-2.55m-253.88-56.9c1.24 2.91-1.24 5.83 0 8.74-1.24-2.91 1.24-5.83 0-8.74m735.96 885.73-25.32 17.58c-1.64 9.45-3.28 18.9-5 28.8h72.24c0-14.59-.97-27.72.34-40.61.87-8.56 2.71-18.87 8.08-24.82 47.78-52.98 66.64-115.78 65.65-185.78-6.82 4.82-14.03 9.18-20.38 14.54-17.18 14.49-21.33 42.61-48.67 46.55.78 53.28-15.32 101.04-46.93 143.74Zm42.11-156.42c1.44 2.72 2.87 5.43 4.31 8.15-1.44-2.72-2.87-5.43-4.31-8.15"
                ></path>
            </svg>
        ),
        "Semantic Kernel": () => (
        ...
        AutoGen: () => <svg xmlns="http://www.w3.org/2000/svg" className="w-14 h-14" fill="none" viewBox="0 0 16 16">
            <path
                id="SVGRepo_iconCarrier"
                fill="#0089D6"
        ...
        "Hugging Face Transformers": () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 80 80"
                                                className="w-14 h-14">
            <g id="SVGRepo_iconCarrier">
                <path
        ...
        "AWS SageMaker & Bedrock": () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16"
                                              className="w-8 h-8">
            <g id="SVGRepo_iconCarrier">
                <path
                    fill="#252F3E"
        ...
        "IBM Watson": () => (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-14 h-14">
                <path
                    id="SVGRepo_iconCarrier"
                    d="M14.834 20.264c-2.534 0-5.224-1.257-7.136-3.002.989-4.477 4.969-9.45 7.522-9.45.289 0 .533.06.865.256.505.325.963.688 1.349 1.071 1.166 1.157 2.264 3.117 2.264 5.517 0 1.878-.633 3.339-1.307 4.241-.733.981-2.111 1.367-3.557 1.367m-2.97 2.038c-1.65 0-3.016-.569-3.612-.87-.797-.416-1.006-1.171-1.006-2.127q0-.418.052-.852c2.011 1.622 4.69 2.765 7.377 2.765.591 0 1.134-.097 1.626-.228l.001.001c-.897.625-2.492 1.311-4.438 1.311M12.458 6a8.4 8.4 0 0 0-2.452.403c-.051.017-.112.047-.112.101 0 .058.046.087.083.087s.165-.033.249-.046a7.7 7.7 0 0 1 1.455-.111c.789 0 1.599.16 2.375.431-3.099 1.173-6.152 5.54-7.211 9.453-1.125-1.275-1.832-2.723-1.832-4.109 0-2.272 1.846-3.668 4.524-3.668.1 0 .154 0 .197-.011a.08.08 0 0 0 .065-.083q-.002-.072-.099-.088a7 7 0 0 0-1.027-.08c-2.658 0-4.593 1.396-4.593 3.936 0 1.728.981 3.601 2.523 5.18a9 9 0 0 0-.151 1.586c0 .197.02.611.089 1.046-.919-.83-1.633-1.826-2.02-2.876-.076-.206-.22-.585-.258-.743-.019-.077-.046-.104-.103-.104-.049 0-.085.038-.085.097 0 .069.027.241.037.295.526 2.893 3.336 6.511 7.909 6.511 5.074 0 8.582-4.272 8.582-8.718C20.604 9.897 17.159 6 12.458 6m9.072 3.786 2.237-1.315a.48.48 0 0 0 .171-.649.46.46 0 0 0-.629-.178l-.008.005-2.237 1.315a.48.48 0 0 0-.171.648.47.47 0 0 0 .404.238.5.5 0 0 0 .233-.064M17.641 5.54l1.315-2.237a.46.46 0 0 0-.165-.632l-.009-.005a.48.48 0 0 0-.648.171l-1.315 2.237a.46.46 0 0 0 .165.632l.009.005a.48.48 0 0 0 .648-.171m-5.188-1.605V1.273c0-.265-.203-.48-.453-.48s-.453.215-.453.48v2.661c0 .266.203.481.453.481s.453-.215.453-.48M6.782 5.711a.46.46 0 0 0 .178-.628l-.004-.009-1.315-2.237a.48.48 0 0 0-.648-.171.463.463 0 0 0-.179.629l.005.009L6.133 5.54a.476.476 0 0 0 .649.171M2.703 9.849a.46.46 0 0 1-.233-.063L.234 8.471a.48.48 0 0 1-.171-.649.46.46 0 0 1 .628-.179l.009.006 2.237 1.315a.48.48 0 0 1 .171.648.47.47 0 0 1-.405.237"
                ></path>
            </svg>
        ),
        "Oracle Cloud AI": () => (
        ...
        >
            <g data-name="Layer 2">
                ...
                ></path>
                <path fill="#0028AA" d="M102.55 182.98h65.42l-40.17-32.23z"></path>
                <path
                    fill="#014BD1"
                ...
                <path
                    fill="#BEDCFF"
                    d="m83.56 52.3.01-.01 38.69-48.52-62.39 30.05-15.41 67.51z"
                ></path>
                <path fill="#6CA1FF" d="m45.32 122.05 41.44 51.96-3.95-98.98z"></path>
                <path fill="#A1C3FF" d="M202.31 28.73 142.65 0l-37.13 46.56z"></path>
                <g strokeMiterlimit="10" strokeWidth="3.2">
                    <path
                        fill="#4279F4"
                        stroke="#4279F4"
                        d="M1.6 272v-44.78h5.74v23.41l20.48-23.41h6.4l-17.39 19.7 19 25.07H29.1l-15.92-20.8-5.84 6.65V272zm40.02-9.79V240h5.43v22.39a4.67 4.67 0 0 0 2.35 4.19 11 11 0 0 0 11 0 4.69 4.69 0 0 0 2.33-4.19V240h5.43v22.19a9.08 9.08 0 0 1-4.1 7.87 16.2 16.2 0 0 1-18.37 0 9.07 9.07 0 0 1-4.07-7.85zM77.46 272v-48h5.43v16.81a29.3 29.3 0 0 1 9.32-1.73 13.1 13.1 0 0 1 6.2 1.41 10.7 10.7 0 0 1 4.18 3.74 18 18 0 0 1 2.23 5.06 21.3 21.3 0 0 1 .73 5.58q0 8.43-4.38 12.79T87.35 272zm5.43-4.87h4.55q6.77 0 9.72-2.95t3-9.51a14.2 14.2 0 0 0-2-7.52 6.55 6.55 0 0 0-6-3.22 24.7 24.7 0 0 0-9.25 1.54zm29.47-11.19q0-7.71 4.09-12.3a13.75 13.75 0 0 1 10.8-4.59q13.35 0 13.36 18.86h-22.82a12.3 12.3 0 0 0 2.9 7.07q2.59 3.11 7.9 3.1a24.9 24.9 0 0 0 10.55-2v5a27.7 27.7 0 0 1-9.86 1.87 19.8 19.8 0 0 1-7.7-1.37 13.3 13.3 0 0 1-5.28-3.76 16.2 16.2 0 0 1-3-5.38 20.8 20.8 0 0 1-.94-6.5zm5.62-2.12h17.26a14.9 14.9 0 0 0-2.37-7.12 6.44 6.44 0 0 0-5.62-2.78 8.2 8.2 0 0 0-6.21 2.72 12.07 12.07 0 0 0-3.04 7.18z"
                    ></path>
                    <path
                        fill="#0028AA"
                        stroke="#0028AA"
                        d="M147.32 244.89V240h5v-7.59a8.14 8.14 0 0 1 2.31-6.05 7.8 7.8 0 0 1 5.69-2.28h7.86V229h-5c-2.21 0-3.67.45-4.37 1.34s-1.06 2.55-1.06 5V240h8.46v4.87h-8.46V272h-5.44v-27.1zM175.26 272v-48h5.43v48zm19.15-3.95a17.86 17.86 0 1 1 12.33 4.9 16.57 16.57 0 0 1-12.33-4.9zm3.84-20.65a13.16 13.16 0 0 0 0 17.2 12.07 12.07 0 0 0 17 0 13.09 13.09 0 0 0 0-17.2 12.07 12.07 0 0 0-17 0zm30.2-7.4h5.75l7.3 25.32 7.43-25.32h5.36l7.34 25.34L269 240h5.74l-10.04 32h-6.12l-6.83-24.58L245 272h-6.47z"
                    ></path>
                </g>
            </g>
        </svg>,
        ...
        >
            <path
                fill="#000"
                d="M0 31.032v-15.53h3.543v1.968c.893-1.594 2.84-2.425 4.593-2.425 2.042 0 3.828.926 4.658 2.745 1.216-2.043 3.034-2.745 5.043-2.745 2.81 0 5.49 1.787 5.49 5.904v10.083h-3.574v-9.478c0-1.818-.926-3.19-3-3.19-1.947 0-3.224 1.53-3.224 3.445v9.22H9.893v-9.475c0-1.786-.898-3.18-3.003-3.18-1.977 0-3.223 1.467-3.223 3.444v9.221Zm27.855 0V7.929h3.703v23.103Zm2.215 8.455c.833.232 1.582.383 3.17.383 2.953 0 6.436-1.665 7.353-6.339l3.786-18.739h5.629l.687-3.117h-5.686l.765-3.725c.586-2.892 2.186-4.358 4.754-4.358.668 0 .48.058 1.076.17L52.427.57c-.793-.237-1.503-.379-3.049-.379a7.32 7.32 0 0 0-4.528 1.484c-1.441 1.114-2.393 2.75-2.827 4.863l-1.066 5.137h-5.034l-.411 3.12h4.823L36.859 32.12c-.383 1.965-1.5 4.315-4.708 4.315-.727 0-.463-.055-1.121-.162Zm23.272-8.582H49.64l5.074-23.309h3.701Zm18.465-14.428A7.962 7.962 0 0 0 60.97 27.904l2.425-1.78a5.005 5.005 0 0 1 3.845-8.145v1.895Zm-9.189 12.995a7.962 7.962 0 0 0 10.836-11.428l-2.425 1.78a5.005 5.005 0 0 1-3.845 8.145v-1.894Zm15.474-13.979h4.044l.823 10.612 5.759-10.612 3.839.055 1.508 10.557 5.074-10.612 3.701.055-7.678 15.493H91.46l-1.783-11.106-5.895 11.106h-3.84Zm26.98.275h-.766v-.266h1.845v.272h-.765v2.243h-.314Zm1.542-.266h.383l.482 1.34q.091.259.178.524h.018c.059-.176.113-.352.172-.524l.478-1.34h.383v2.515h-.298V16.63c0-.22.024-.523.04-.747h-.016l-.191.574-.475 1.304h-.208l-.481-1.302-.191-.574h-.015c.017.224.042.527.042.747v1.387h-.291Z"
            ></path>
        </svg>,
        "TensorFlow Serving": () => <svg
            className="w-14 h-14"
            xmlns="http://www.w3.org/2000/svg"
            preserveAspectRatio="xMidYMid"
            viewBox="-9 0 274 274"
        ...
        "NVIDIA Triton": () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" className="w-14 h-14">
            <g id="SVGRepo_iconCarrier">
                <circle cx="512.25" cy="512.25" r="512" fill="#76b900"></circle>
                <path
                    fill="#fff"
    ...
    const techCategories = [
        {
            ...
            icons: ["TensorFlow", "PyTorch", "Scikit-learn", "Keras ", "AutoGen", "CrewAI", "LlamaIndex", "LangChain ", "Hugging Face Transformers"],
        },
        {
        ...
        },
        {
            ...
            icons: ["AWS SageMaker & Bedrock", "Microsoft Azure AI", "Google Cloud AI Platform", "IBM Watson", "Oracle Cloud AI"],
        },
        {
            title: "MLOps & Deployment",
            icons: ["Docker", "Kubernetes", "MLflow", "Kubeflow", "TensorFlow Serving", "NVIDIA Triton"],
        },
    ];
    return (
        <div className="font-syne">
            ...
            <HeroSection
                ...
                description="Partner with a leading AI development company to unlock intelligent automation, predictive insights, and next-gen generative AI solutions. We design and deploy custom AI solutions for business that reduce costs, improve efficiency, and drive digital transformation across industries"
                formLabel="Ai and Generative Ai Solutions Consultation?"
                ...
                services={[
                    {
                        ...
                        duration: "Understanding Your Vision",
                        description: "Our experts work with you to establish clear goals for AI implementation and pinpoint the target outcomes you aim to achieve. We conduct comprehensive assessments to understand your business challenges and opportunities",
                        keyActivities: [
                    ...
                    },
                    {
                        ...
                        duration: "Building the Foundation",
                        description:
                            "Our team handles data preparation, transformation, and engineering tasks, ensuring that your data is clean, structured, and optimized for AI model training and analysis",
                        keyActivities: [
                    ...
                    },
                    {
                        ...
                        duration: "Seamless Implementation",
                        description:
                            "We provide seamless integration of AI capabilities into your existing systems and workflows, ensuring smooth operation and minimal disruption to your business processes.",
                        keyActivities: [
            ...
            />
            <OurStack
                heading="Our AI & Generative AI Technology"
            ...
            <FinalCTASection
                ...
                description="Partner with our AI development company to unlock the power of artificial intelligence and generative AI solutions. Whether you need AI consulting services, custom AI solutions for business, or full-scale AI implementation services, our team of experts is ready to help you achieve measurable results"
                subHeading="Contact us for a complimentary consultation to discuss how our AI and generative AI solutions can transform your business operations, enhance decision-making, and drive sustainable growth"
            />
            ...
            <OurModals
                ...
                subheadingTwo="Fixed Price Projects"
                subDescriptionTwo="Optimize your AI projects with minimum risks, assuring quality and on-time/on-budget delivery. Perfect for well-defined AI implementations with clear scope and requirements."
                BestForTwo="Specific AI solutions with defined deliverables"
            />
            <FaqSection Faq={faqs}/>
            <Footer/>
        </div>
